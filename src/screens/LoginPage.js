                    ...
                    <div className="text-center">
                        ...
                        </div>
                        {
                             <div className="mb-8 text-xl font-bold">
                                {isShown?"Create Account":"Login"}
                            </div>
                        }
                        {
                            isShown && <TextBox maxLength={20} outerClass={"mb-6"} width={"100%"} input={username} onChange={(e) => { setUser(e.target.value) }} placeholder="UserName" inputClass={"pl-4"} />
                        ...
                        <Button text={"Login"} />
                        <div className="mt-10 text-[13px]"><span className="opacity-50 mr-2">Don't have an account?</span><span onClick={handleClick} className="opacity-100 cursor-pointer">Create</span></div>
                    </div>
                </div>
            </div>
        </>
